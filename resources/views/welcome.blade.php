  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <h1 class="logo mr-auto"><a href="index.html">HOSI TECHNOLOGIES</a></h1>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/intro-carousel/1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Software Engineering</h2>
                <p class="animate__animated animate__fadeInUp">Our mission is to provide customers with top quality software development solutions at affordable prices, with quick delivery, while maintaining stringent ethical standards at any phase of business or software development.Our mission is to provide customers with top quality software development solutions at affordable prices, with quick delivery, while maintaining stringent ethical standards at any phase of business or software development.</p>
          ...
          <div class="carousel-item" style="background-image: url(assets/img/intro-carousel/3.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">HOSI ACADEMY</h2>
                <p class="animate__animated animate__fadeInUp">Java Programming Training and Certification.</p>
                <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a>
              </div>
            </div>
          </div>
